...
namespace QzgfFrame.Archives.MaintainTypeManger.Models
{
    /// <summary>
    /// auto gen
    /// </summary>
    [Serializable]
    public sealed class ArchiveMaintainType
    {
        ...
        /// full constructor
        /// </summary>
        public ArchiveMaintainType(string id, string maintainTypename)
        {
            _id = id;
        ...
        {
            get { return _maintainTypename.Trim(); }
            set
            {
                if (value != null)
                    if (value.Length > 256)
