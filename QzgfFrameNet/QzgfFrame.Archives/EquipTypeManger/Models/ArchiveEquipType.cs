...
namespace QzgfFrame.Archives.EquipTypeManger.Models
{
    /// <summary>
    /// auto gen
    /// </summary>
    [Serializable]
    public sealed class ArchiveEquipType
    {
        ...
        /// full constructor
        /// </summary>
        public ArchiveEquipType(string id, string equiptypename)
        {
            _id = id;
