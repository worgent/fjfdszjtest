...
function AddSuppliesRow(SuppliesType) { //读取最后一行的行号，存放在txtTRLastIndex文本框中
    ...
    newNumTD.innerHTML = "<input type='text' name='Num" + rowID + "' id='Num" + rowID + "' onkeyup='GetCount(" + rowID + ")' value='' class = 'dd-text' validate = '{required:true,isNumCode:true}'/><input type='hidden' name='MaxNum" + rowID + "' id='MaxNum" + rowID + "'/><input type='hidden' value='0' name='NumFlag" + rowID + "' id='NumFlag" + rowID + "'/>";
