...
var gosArray = new Array(); //保存营业部，耗材,解决重复问题
...
$(function () {
    ...
    $("#CompanyName0").addClass("disable-dd-text");
                ...
                if (resu != null) {
                    ...
                    for (var i = 0; i < arys.length; i++) {
                        ...
                        for (var k = 0; k < gosArray.length; k++) {
                            ...
                            if (goObject.sid == SuppliesType.SaleDepartmentId && goObject.tid == SuppliesType.SuppliesTypeId) {
                                selFlag = false;
                            }
                        }
                        var idsFlag = true;
                        ...
                        if (selFlag) {
                            ...
                            if (addgid) {
                                var goObject = new Object(); //sid,orgid
                                goObject.sid = SuppliesType.SaleDepartmentId;
                                ...
                                if (rowFlag) {
                                    ...
                                    $("#CompanyId0").val(SuppliesType.CompanyId);
                                    $("#SaleDepartmentId0").val(SuppliesType.SaleDepartmentId);
                                    $("#SaleDepartmentName0").val(SuppliesType.SaleDepartmentName);
...
function f_addh() {
    ...
    strid = GetOrgIds();
    strid += ";" + GetTids();
    f_openWindow('/Supplies/SuppliesStock/SelYwIndex/?id=' + strid, '选择耗材', 700, 350);
}
function GetCount(i) {
...
function f_save() {
    ...
    if (ok) {
        window.location.href = "/Supplies/Distribution/add/?TypeFlag=YW&id=0&frameid=" + $("#frameid").val();
    }
    else
