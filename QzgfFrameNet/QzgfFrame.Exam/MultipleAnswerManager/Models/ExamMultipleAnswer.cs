...
namespace QzgfFrame.Exam.MultipleAnswerManager.Models
{
    /// <summary>
    /// "选择题"回答表
    /// </summary>
    [Serializable]
    public sealed class ExamMultipleAnswer
    {
        ...
        /// full constructor
        /// </summary>
        public ExamMultipleAnswer(string id, string answerexamid, string answercontent)
        {
            _id = id;
