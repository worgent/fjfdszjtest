...
namespace QzgfFrame.Exam.FillBlanksAnswerManager.Models
{
    /// <summary>
    /// "填空题"回答表
    /// </summary>
    [Serializable]
    public sealed class ExamFillBlanksAnswer
    {
        ...
        /// full constructor
        /// </summary>
        public ExamFillBlanksAnswer(string id, string answerexamid, string answercontent)
        {
            _id = id;
