...
namespace QzgfFrame.Exam.TestExerciseManger.Models
{
	...
	/// </summary>
	[Serializable]
    public sealed class ExamTestExercise 
	{
		...
		/// full constructor
		/// </summary>
        public ExamTestExercise(string id, string testid, string creatorid, DateTime createtime, string pass, bool isdelete)
		{
			_id = id;
            _testid = testid;
