...
namespace QzgfFrame.Exam.TestSetManger.Models
{
	...
	/// </summary>
	[Serializable]
    public sealed class ExamTestSet 
	{
		...
		/// full constructor
		/// </summary>
        public ExamTestSet(string id,string testid, DateTime begintime, DateTime endtime, string timelength,string creatorid,DateTime createtime, string pass,bool isdelete)
		{
			_id = id;
            _testid = testid;
		...
		public DateTime? BeginTime
		{
			...
			set	
			{
                _isChanged |= (_begintime != value); _begintime = value;
			}
		}
