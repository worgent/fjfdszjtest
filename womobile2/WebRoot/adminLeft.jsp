...
var OUTLOOKBAR_DEFINITION = {
	format:{
		target:'main',
		blankImage:'SlideMenu/images/bex.gif',
		rollback:true,
		animationSteps:3,
		animationDelay:20,
		templates:{
			...
			upArrow:{
				common:'<img src="SlideMenu/images/btn_up_{state}.gif" width="24" height="24" />',
				normal:{state:'n'}
			},
			downArrow:{
				common:'<img src="SlideMenu/images/btn_down_{state}.gif" width="24" height="24" />',
				normal:{state:'n'}
			}
		}
	},
