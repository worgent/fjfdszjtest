// Decompiled by DJ v3.9.9.91 Copyright 2005 Atanas Neshkov  Date: 2007-2-1 0:11:16
// Home Page : http://members.fortunecity.com/neshkov/dj.html  - Check often for new version!
// Decompiler options: packimports(3) 
// Source File Name:   SmartUpload.java

package upload.jspsmart.upload;
...
public class SmartUpload
{
        ...
        throws ServletException, IOException, SmartUploadException
    {
        ...
        for(m_currentIndex++; m_currentIndex < m_totalBytes; m_currentIndex = m_currentIndex + 2)
        {
            ...
            if(flag3)
            {
                upload.jspsmart.upload.File file = new upload.jspsmart.upload.File();
                file.setParent(this);
