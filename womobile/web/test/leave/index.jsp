...
<html>
	...
	<body>
		<a href="deploy.do">发布新流程</a>&nbsp;[
		username: ${user }]
		<a href="test/leave/login.jsp">登陆</a>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a href="remove.do?id=${deploymentId }">remove</a>
						&nbsp;|&nbsp;
						<a href="start.do?id=${id }">start</a>
					</td>
				</tr>
				</s:iterator>
			</tbody>
