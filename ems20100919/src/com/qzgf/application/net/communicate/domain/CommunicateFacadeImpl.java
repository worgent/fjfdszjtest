...
public class CommunicateFacadeImpl implements CommunicateFacade {
	...
	private String url=Constant.EmsUrl;//请求的url地址
	...
	public HashMap SendCom(String urlStr, String per,byte[] stream) {
		...
		try {
			...
			//e.printStackTrace();
			System.out.println("与派揽通信异常SendCom");
		} finally {
			if (connection != null) {
	...
	public List findImmigration(HashMap map) {
		return baseSqlMapDAO.queryForList("Communicate.findImmigration", map);
	}
	/**
	 * 
	...
	public int modifyImmigration(HashMap map) {
		return baseSqlMapDAO.update("Communicate.modifyImmigration", map);
	}
	...
	public List findYd12580(HashMap map) {
		return baseSqlMapDAO.queryForList("Communicate.findYd12580", map);
	}
	...
	public int modifyYd12580(HashMap map) {
		return baseSqlMapDAO.update("Communicate.modifyYd12580", map);
	}
	...
	public int addsuccessnum(HashMap map) {
		return baseSqlMapDAO.update("Order.addsuccessnum", map);
	}
