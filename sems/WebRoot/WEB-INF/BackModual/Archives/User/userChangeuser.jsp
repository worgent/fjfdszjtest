...
<form  method='POST' name='form1' action='<%=basePath%>/archives/user.do?action=changeuser'  id="form1">
 ...
 <script type="text/javascript">
    ...
    $(document).ready(function(){
		...
		$("#ptel").formValidator({onshow:def_Showtel,onfocus:def_Showtel,oncorrect:" "}).regexValidator({regexp:"^$|^[0-9\\-]+$",onerror:def_Errortel});
		$("#pmobile").formValidator({onshow:def_Showmobile,onfocus:def_Showmobile,oncorrect:" "}).regexValidator({regexp:"^(13|15|18)[0-9]{9}$|^\\d{10,12}$",onerror:def_Errormobile});
