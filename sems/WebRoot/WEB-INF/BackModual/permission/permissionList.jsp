			...
			<tr>
				<td>
					<table width="100%" border="0" cellpadding="5" cellspacing="0">
						...
						<tr>
							<td colspan="4">
								<input type="button" name="addMenuButton" value="添加菜单"
									class="button2" onclick="addMenuButton();" />
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="button" name="delMenuButton" value="删除菜单"
									class="button2" onclick="delMenuButton(this);" />
							</td>
						</tr>
					</table>
					<div id="menuSet"></div>
