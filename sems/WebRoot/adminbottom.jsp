	...
	<table border="0" cellpadding="0" style="border-collapse: collapse" width="100%" id="table4">
				<tr>
					...
					<tr>
												...
												<td style="font-size: 9pt;FONT-SIZE: 9pt; FONT-FAMILY: Tahoma,宋体;cursor:hand;"  onclick="parent.location='/news.do?action=fir&search.ptab=1';setborder();itemnow.innerText=sttgro.innerText;itemnow.title=sttgro.title" >
												<font color="#FFFFFF"> 
												[退出登录]
												</font>
												</td>
