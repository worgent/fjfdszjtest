...
public class AddressFacadeImpl implements AddressFacade {
	...
	/**
	 * Written by   : fjfdszj
	 * Create Date  : Mar 20, 2010 1:02:48 AM 
	 * Purpose      : 同时更新用户的地址信息
	 * @param map
	 * @return 
	 */
	 ...
	 * @return
	 */
	public int countAddress(HashMap map){
		return  ((Integer)baseSqlMapDAO.queryForObject("Address.findAddressCount", map)).intValue();
	}
