...
public class RoleFacadeImpl implements RoleFacade {
	...
	public int insertRole(HashMap map)throws Exception{
		//1.获得角色ID
		long id=Long.parseLong((String)baseSqlMapDAO.queryForObject("role.createNewId",null));
	...
	public List findAllPermission(String userId) {
		List permissionList = baseSqlMapDAO.queryForList("role.findAllPermission", userId);
		return permissionList;
	}
