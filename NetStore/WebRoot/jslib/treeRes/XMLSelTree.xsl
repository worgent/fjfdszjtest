...
<xsl:variable name="LeafImgSrc">/jslib/treeRes/images/NodeImg0.gif</xsl:variable>
<xsl:variable name="BranchImgSrc">/jslib/treeRes/images/NodeImg1.gif</xsl:variable>
