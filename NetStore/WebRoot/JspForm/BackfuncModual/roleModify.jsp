			...
			<table class="tbl" width="80%"  cellspacing="0" cellpadding="0">
				...
				<tr>
					...
					<td class="main" align="left" >
						<input type="text" name="roleName" value="${roleMap.roleName}" />
					</td>
				</tr>
				
				<tr>
					<td colspan="2" class="main"  align="center">
						<input type="hidden" name="status" value="updateRole"/>
						<input type="submit" value="保存" class="button"/>
						<input type="button" value="返回" class="button" onclick="javascript:self.history.back(); "/>					</td>
				</tr>
			</table>
		</center>
	</form>
