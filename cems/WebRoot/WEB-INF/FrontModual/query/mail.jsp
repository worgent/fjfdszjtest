					...
					<div align="center">
						<table border="0" width="687" id="table50" cellpadding="0" style="border-collapse: collapse">
							...
							<tr>
								...
								<table border="1" cellSpacing="0" cellPadding="0" width="100%"  id="table53">
									<tr>
										<td height="14" >
											<table width="100%" border="1">
												<tr>
													<td align="left" width="25%">收寄时间:</td><td width="25%"><s:property value="%{search.receiveTime}"/></td>
													<td width="25%">收寄局:</td><td width="25%"><s:property value="%{search.receiveBureau}"/></td>
												</tr>
												<tr>
													<td align="left" width="25%">寄达地:</td><td width="25%"><s:property value="%{search.sendAddress}"/></td>
													<td width="25%">邮件种类:</td><td width="25%"><s:property value="%{search.postType}"/></td>
												</tr>
												<tr>
													<td align="left" width="25%">邮件性质:</td><td width="25%"><s:property value="%{search.postKind}"/></td>
													<td width="25%">邮件编号:</td><td width="25%"><s:property value="%{search.mailNum}"/></td>
												</tr>
												<tr>
													<td align="left" width="25%">最后处理时间</td><td width="25%"><s:property value="%{search.nowHandleTime}"/></td>
													<td width="25%">地点:</td><td width="25%"><div id="td42"><s:property value="%{search.nowHandle}"/></div></td>
												</tr>
										...
										<td height="14" width="100%" >
											<table width="100%" border="1"  id="table53">
												<s:iterator id="detail" value="%{search.detailList}">
													<tr>
														<td><s:property value="#detail.time"/></td> <td><s:property value="#detail.handleAddress"/></td> 
														<td><s:property value="#detail.handleAction"/></td> <td><s:property value="#detail.handleExplain"/></td>
