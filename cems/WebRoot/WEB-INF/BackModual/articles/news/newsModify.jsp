  ...
  function cataReturn(obj)
{
	 ...
	 <form action="/news.do?action=modifySave"  method="post" >
	 <center>
	 <table border="0" cellpadding="0" style="border-collapse: collapse" width="650" id="table3" height="648" bordercolor="#FFFFFF" cellspacing="0">
		<tr>
			<td valign="top">
							...
							<tr>
								...
								<table border="0" cellpadding="0" style="border-collapse: collapse" width="687" id="table54" background="images/nei01.jpg" height="34">
									<tr>
										...
										<span style="font-weight: 700"><strong> <font color="#ff0000">编辑文章</font>
			...
			border="0" cellpadding="0" cellspacing="1" width="100%">
						...
						<tr>
							...
							<td class="main"  colspan="2" align="left">
					          <select id="articlestype" name="search.articlestype">
					            <option value="1"   <s:if test="search.ARTICLESTYPE==1">selected</s:if>  > 企业品牌 </option>
					            <option value="2"   <s:if test="search.ARTICLESTYPE==2">selected</s:if>  > 企业文化</option>
					            <option value="3"   <s:if test="search.ARTICLESTYPE==3">selected</s:if>  > 新闻动态</option>
					            <option value="4"   <s:if test="search.ARTICLESTYPE==4">selected</s:if>  > EMS新闻</option>
					            <option value="5"   <s:if test="search.ARTICLESTYPE==5">selected</s:if>  > 行业动态</option>
					            <option value="6"   <s:if test="search.ARTICLESTYPE==6">selected</s:if>  >公 告</option>  
					...
					<td class="main"  colspan="2" align="left">
						<input type="text" id="titleId" name="search.title"   value="<s:property value="search.TITLE" />"   size="50" /><font color="#ff0000">*</font>
						</td>
				    </tr>
					...
					<td class="main"  colspan="2" align="left">
						<input type="text" id="sourceId" name="search.source"   value="<s:property value="search.SOURCE" />"    size="50" />
					</td>
				    </tr>
					...
					<td class="main"  colspan="2" align="left">
						<input type="text" id="authorID" name="search.author"   value="<s:property value="search.AUTHOR" />"   />
					</td>
				    </tr>
                  ...
                  flashUploadURL="/fckeditor/editor/filemanager/upload/simpleuploader?Type=Flash">
                   <s:property value="search.CONTENT" />
                  </fck:editor>   
       ...
       此处假定将FCKeditor解压包中的editor目录直接放在项目的WebRoot下，fckeditortest是项目名  -->	    
					...
					<td class="main" colspan="2" align="left">
						<input type="checkbox" id="isaudit" name="search.isaudit"
							<s:if test="search.ISAUDIT==1">checked</s:if>   value="1"/><font  color="#ff0000" size="2">（如果选中的话将直接发布）</font>
				</td>
				</tr>
						<tr>
					<td class="main" align="left">&nbsp; 
					...
					<td class="main" colspan="2" align="left">
				    <s:property value="search.RELEASETIME" />
					 <input type="hidden" id="newsid" name="search.newsid"   value="<s:property value="search.NEWSID" />"  />
...
　<p style="text-align: center; line-height: 200%; text-indent: 18.05pt; margin-left: 0cm; margin-right: 0cm; margin-top: 0cm; margin-bottom: 0pt" class="MsoNormal" align="center">
			...
			<table border="0" cellpadding="0" style="border-collapse: collapse" width="690" id="table10" background="images/di.jpg" height="27">
				<tr>
