	 ...
	 <table border="0" cellpadding="0" style="border-collapse: collapse" width="700" id="table3" height="648" bordercolor="#FFFFFF" cellspacing="0">
							...
							<tr>
								...
								<table border="0" cellpadding="0" style="border-collapse: collapse" width="687" id="table54" background="images/nei01.jpg" height="34">
									<tr>
										...
										<span style="font-weight: 700"><strong> <font color="#ff0000">文章信息管理</font>
		...
		<table border="0" width="100%" align="center" cellpadding="0"
			...
			<tr>
				...
				<td valign="top">
					<a href="news.do?action=add"> 添加</a>
				</td>
			</tr>
		</table>
		<table id="myTable"  class="tablesorter" align="center"
			border="0" cellpadding="0" cellspacing="1">
				...
				<s:iterator id="news" value="%{pageList.objectList}">
					<tr>
						<td class="bgColor3">
							<s:if test="#news.ARTICLESTYPE==1">企业品牌</s:if>
							<s:if test="#news.ARTICLESTYPE==2">企业文化</s:if>
							<s:if test="#news.ARTICLESTYPE==3">新闻动态</s:if>
							<s:if test="#news.ARTICLESTYPE==4">EMS新闻</s:if>
							<s:if test="#news.ARTICLESTYPE==5">行业动态</s:if>
							<s:if test="#news.ARTICLESTYPE==6">公 告</s:if>
						</td>
						<td class="bgColor4">
						...
						<td class="bgColor4">
							<s:property value="#news.RELEASETIME" />
						</td>
						<td class="bgColor4">
							<s:if test="#news.ISAUDIT==1">已审核</s:if>
							<s:if test="#news.ISAUDIT!=1">未审核</s:if>

						</td>

						<td class="bgColor4" align="left">
							<a href="/news.do?action=editOnlyNews&search.newsID=<s:property value="#news.NEWSID"/>">修改</a>
							|
							<a href="javascript:fun_delete(<s:property value="#news.NEWSID"/>);">删除</a>
						</td>
