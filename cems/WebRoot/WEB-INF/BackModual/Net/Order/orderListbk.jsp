			...
			<div id="f_tabs">
				<ul>
					<li id="tab1" class="f_tabClass1">
						<a href="javascript:;" onclick="loadDefaultList('<%=path%>/net/order.do?action=listdetail&search.porderingstate=等待寄件',1,3);">等待寄件</a>
					</li>
					<li id="tab2" class="f_tabClass2">
						<a href="javascript:;" onclick="loadDefaultList('<%=path%>/net/order.do?action=listdetail&search.porderingstate=揽收成功',2,3);">揽收成功</a>
					</li>
...
<script language="javascript" type="text/javascript">	
		    ...
		    //默认加载页面
		    loadDefaultList('<%=path%>/net/order.do?action=listdetail&search.porderingstate=等待寄件',1,3);
		    //验证	
