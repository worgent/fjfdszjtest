...
-->
	  ...
	  <div id="Layer41"><!--邮件类型-->
		<input type="radio" name="search.psendmailtype" id="psendmailtype0" value="0" <s:if test="%{search.SENDMAILTYPE==0}">checked</s:if> /><label for="psendmailtype0">信函</label>
		<input type="radio" name="search.psendmailtype" id="psendmailtype1" value="1" <s:if test="%{search.SENDMAILTYPE==1}">checked</s:if> /><label for="psendmailtype1">文件资料</label>
		<input type="radio" name="search.psendmailtype" id="psendmailtype2" value="2" <s:if test="%{search.SENDMAILTYPE==2}">checked</s:if> /><label for="psendmailtype2">物品</label>	
 	   </div>
