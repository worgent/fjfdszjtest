...
//			log.debug("Clean Out Session Listener");
		//判断清除的是否是为net.trust.application.systemManage.manager.dto.UserInfo对象
		if (arg0.getValue() != null){
			if (arg0.getValue().getClass().getName().equals("net.trust.application.systemManage.manager.dto.UserInfo")){
