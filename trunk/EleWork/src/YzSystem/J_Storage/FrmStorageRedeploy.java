...
public class FrmStorageRedeploy extends FrmFunctionBase {
    public String billType = "2002";
    public String pre = "SBDP";
    
    public void init() {
    }

    //生成的页面流程控制
    public FrmStorageRedeploy() throws wlglException {
        super();
        init();
        // 设置页面标题
        Table = "tbstorageredeploy";
        seqnField = "BillNo";
        DetailTable = "tbstorageredeployitem";
...
//=========================修改设置==============================================
    ...
    private void setQueryInfo() {
        qry_selectSQL ="select 	a.BillNo, a.TheDate, a.StorageOut,b.TheName StorageOutName,a.StorageIn,c.TheName StorageInName," +
        		"\n"+"a.BillSortCode,d.BillName BillSortName,a.Remark" +
        		"\n"+"from tbstorageredeploy a" +
        		"\n"+"left outer join tbdatumstorage b on b.TheCode=a.StorageOut" +
        		"\n"+"left outer join tbdatumstorage c on c.TheCode=a.StorageIn" +
        ...
        prop4.setProperty("title", "调出仓库");
        prop4.setProperty("data", "3");
        columnsInfo.add(prop4);

        Properties prop5 = new Properties();
        prop5.setProperty("title", "调入仓库");
    ...
    protected void setUpdateComp() throws wlglException {
        ...
        ec3.setField("StorageOut");
        ec3.setCaption("调出仓库");
        ec3.setDisID("StorageOutName");
        ...
        ec4.setEdtType("Storage");
        ec4.setField("StorageIn");
        ec4.setCaption("调入仓库");
        ec4.setDisID("StorageInName");
    ...
    protected void setUpdateInfo() {
        ...
        edt_selectSQL ="select 	a.BillNo, a.TheDate, a.StorageOut,b.TheName StorageOutName,a.StorageIn,c.TheName StorageInName," +
		"\n"+"a.BillSortCode,d.BillName BillSortName,a.Remark" +
		"\n"+"from tbstorageredeploy a" +
		"\n"+"left outer join tbdatumstorage b on b.TheCode=a.StorageOut" +
		"\n"+"left outer join tbdatumstorage c on c.TheCode=a.StorageIn" +
    ...
    private void setDetailQueryInfo() {
        ...
        detailSelectSQL = "select a.BillNo, a.RowNo, a.ProductCode, b.TheName ProductName,a.ProductSort,c.TheName ProductTypeName," +
        		...
        		"\n"+"from tbstorageredeployitem a  left outer join tbdatumproduct b on a.ProductCode=b.TheCode and a.ProductSort=b.ProductTypeCode"+
