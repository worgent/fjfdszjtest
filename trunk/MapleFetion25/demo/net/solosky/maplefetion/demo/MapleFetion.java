...
public class MapleFetion extends NotifyEventAdapter
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		*/
		...
		MapleFetion demo = new MapleFetion("13599204724", "my123@123");
	   ...
	   public void verify(String code) {
	    ...
	    public void to(String uri,final String message)
	    {
	    	...
	    	if(buddy!=null) {
	    		...
	    		println("找不到这个好友，请检查你的输入！uri:"+uri);
	    	}
	    }
	    		...
	    		public void run()
	    		{
	    			try {
						...
						*/
	            		...
	            		SendMsgbyLong(msg,"新闻","to 10 ");
	            		SendMsgbyLong(msg,"新闻","self ");
	            		
	            		//天气
	            		msg = Util.dispatch("weather1 ");
	            		SendMsgbyLong(msg,"天气","to 10 ");
	            		msg = Util.dispatch("weather2 ");
	            		SendMsgbyLong(msg,"天气","self ");
