			...
			<div id="f_tabs">
				<ul>
					<li id="tab1" class="f_tabClass1">
						<a href="javascript:;" onclick="loadDefaultList('<%=path%>/archives/clientMsg.do?action=listdetail',1,1);">全部</a>
					</li>
				</ul>
			</div>
		</div>
...
<script language="javascript" type="text/javascript">	
		    ...
		    $(document).ready(function(){
		    	loadDefaultList('<%=path%>/archives/clientMsg.do?action=listdetail',1,1);
		    });
</script>		    		
	</body>
</html>