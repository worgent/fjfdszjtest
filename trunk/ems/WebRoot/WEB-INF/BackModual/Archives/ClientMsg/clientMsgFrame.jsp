...
<table width="100%" border="0" cellpadding="4" cellspacing="0">
	...
	<s:iterator id="g" value="%{pageList.objectList}">
		<tr>
		    <td>
		    	<input type="radio" name="clientMsg" onclick="setValue('<s:property value="#g.ID" />','<s:property value="#g.NAME" />', '<s:property value="#g.MOBILE" />', '<s:property value="#g.UNIT" />','<s:property value="#g.AREACODE" />', '<s:property value="#g.TEL" />')"/>
		    </td>
			<td>
...
<script type="text/javascript">
		function setValue(frmid,frmname, frmmobile, frmunit,frmareacode,frmtel){
			...
			document.all.frmareacode.value = frmareacode;
