...
package com.qzgf.application.perambulate.action;
...
public class PerambulateAction extends BaseStruts2Action implements Preparable,ModelDriven{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 

	//forward paths
	protected static final String QUERY_JSP = "/test/UserInfo/query.jsp";
	protected static final String LIST_JSP= "/mobile/perambulate/list.jsp";
