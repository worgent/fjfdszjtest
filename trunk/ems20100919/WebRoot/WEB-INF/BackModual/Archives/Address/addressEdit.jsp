											...
											<table  border="0" cellpadding="0" style="border-collapse: collapse" width="80%" height="100%" id="table15">
												...
												<TR align="left">
													    <TD rowSpan=2 width="95"><font size="2">地址:</font></TD>
													        <TD width="524"><font size="2">省份:福建省 </font>
												...
												<TR align="left">
													    ...
													    <s:textfield id="paddress"  name="search.paddress"  size="30" value="%{address.ADDRESS}" > </s:textfield>
												...
												<tr align="left">
													...
													<s:if test="%{address.ISCHECK==1}">
														<s:hidden value="1" name="search.pischeck" id="pischeck"></s:hidden>是
													</s:if>
													<s:else>
 ...
 <script type="text/javascript">
  //s:select id="pclientbalance"  name="search.pclientbalance" list="clientbalanceList" headerKey="-1" headerValue="---请选择---" listKey="ID" listValue="NAME" key="ID">s:select
    ...
    $(document).ready(function(){
		...
		//$("#pprovince").formValidator({tipid:"paddressTip",onfocus:"通信地址",oncorrect:"√"}).inputValidator({min:1,onerror:"通信地址不能为空"});
