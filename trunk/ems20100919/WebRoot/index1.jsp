...
-->
				...
				<tr>
					<td width=252 valign="top">
						<table border="0" cellpadding="0"
							...
							background="images/lft1.jpg" height="242">
							<tr>
								<td height="40" align="right" style="vertical-align: middle;">
									<a href="/news.do?action=FrontNews&search.artype=6"
										target="_blank">更多</a>&nbsp;&nbsp;
								</td>
							</tr>
							<tr>
								<td height="194" align="center">
									<font color="#6BBDCF" style="font-size: 9pt"> <marquee
											direction=up scrollAmount=1 height=184
											onMouseOut=this.start(); onMouseOver=this.stop(); width=246
											style="padding: 0;">
											<s:if test="topSixNews!=null">
												<s:iterator id="tsix" value="%{topSixNews.objectList}">
													<a
														href="/news.do?action=newsDetail&search.newsID=<s:property value="#tsix.NEWSID"/>"
														title="<s:property value="#tsix.TITLE"/>" target="_blank"><div
															style="cursor: hand; width: 170px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; float: left; border: 0px; color: #FFFFFF">
															&nbsp;●
															<s:property value="#tsix.TITLE" />
														</div>(<s:property value="#tsix.RELEASETIME" />)</a>
													<br />
												</s:iterator>
											</s:if>
										</marquee> </font>
						...
						<table width="252" border="0" height=242 cellspacing="0"
							cellpadding="0">
							<tr>
								<td height="30">
									<img src="images/left221.jpg" border="0"></img>
								</td>
								<td height="30" class=limenu1 id=li1>
									<div align="center">
										<a class=cheng onMouseMove="divTags('1');" id=herf1
											href="/news.do?action=FrontNews&search.artype=4">福建EMS</a>&nbsp;|
									</div>
								</td>
								<td height="30" class=limenu id=li2>
									<div align="left">
										<a class=hui onMouseMove="divTags('2');" id=herf2
											href="/news.do?action=FrontNews&search.artype=5">行业动态</a>
									</div>
								</td>
							</tr>
							<tr>
								<td height=212 colspan="3">
									<DIV id=divOne style="height: 212">
										<table width="100%" border="0" cellspacing="0"
											background="images/listbg.jpg" height=212 cellpadding="0">
											<tr>
												<td valign="top">
													<s:if test="topEightNews!=null">
														<s:iterator id="teight" value="%{topEightNews.objectList}">
															<table height="23" cellSpacing="0" cellPadding="0"
																...
																background="images/listbg.jpg" border="0" id="table29">
																<tr>
																	<td align="middle" width="22" command="ImageManager">
																		<font color="#FFFFFF"> <span
																			style="font-size: 9pt"> <img alt=""
																					src="images/jiantou1.gif" border="0" width="5"
																					height="9" /> </span> </font>
																	</td>
																	<td align="left">
																		<font color="#FFFFFF"> <span
																			style="font-size: 9pt; text-decoration: none">
																				<a
																				href="/news.do?action=newsDetail&search.newsID=<s:property value="#teight.NEWSID"/>"
																				title="<s:property value="#teight.TITLE"/>"
																				target="_blank">
																					<div
																						style="cursor: hand; width: 220px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; float: left; border: 0px; color: #FFFFFF">
																						<s:property value="#teight.TITLE" />
																					</div> </a> </span> </font>
																	</td>
																</tr>
															</table>
									...
									<DIV class=con_bottom id=divTwo
										style="height: 212; DISPLAY: none">
										<table width="100%" border="0" background="images/listbg.jpg"
											cellspacing="0" height=212 cellpadding="0">
											<tr>
												<td valign="top">
													<s:if test="hangEightNews!=null">
														<s:iterator id="teight"
															value="%{hangEightNews.objectList}">
															<table height="23" cellSpacing="0" cellPadding="0"
																width="100%" align="center"
																background="images/listbg.jpg" border="0" id="table29">
																<tr>
					...
					<td valign="top">
						<table border="0" cellpadding="0"
							style="border-collapse: collapse" width="100%" id="table11">
							<tr>
								<td>
									<div id="slide">
										<a href="#" target="_blank" id="this_a"><img
												src="images/1.jpg" id="this_pic" alt="" />
										</a>
										<ul id="pic_list">
											<li>
												<a href="#" target="_blank"><img src="images/1.jpg"
														alt="" />
												</a>
											</li>
											<li>
												<a href="#" target="_blank"><img src="images/2.jpg"
														alt="" />
												</a>
											</li>
											<li>
												<a href="#" target="_blank"><img src="images/3.jpg"
														alt="" />
												</a>
											</li>
										</ul>
						...
						<table border="0" cellpadding="0" height=30
							style="border-collapse: collapse" width="100%" id="table12">
							<tr height="30">
								<td width="101" height="30px" background="images/navA.jpg"
								...
								<td background="images/navB.jpg" id="td3"
									onclick="loadEmsQuery();" width="101" height="30"
									align="center" style="cursor: hand">
									<font color="#FFFFFF"> <span
										style="font-weight: 700; font-size: 3pt"></span> <span
										style="font-size: 9pt; font-weight: 700">EMS邮件查询</span> </font>
								</td>
								<td background="images/navB.jpg" id="td5"
									onclick="loadTimeQuery();" width="101" height="30"
									align="center" style="cursor: hand">
									<font color="#FFFFFF"> <span
										style="font-weight: 700; font-size: 3pt"></span> <span
								...
								<td background="images/navB.jpg" id="td4"
									onclick="loadBoundQuery();" width="101" height="30"
									align="center" style="cursor: hand">
									<font color="#FFFFFF"> <span
										style="font-weight: 700; font-size: 3pt"></span> <span
								...
								<td background="images/navB.jpg" id="td6"
									onclick="loadMoneyQuery();" width="101" height="30"
									align="center" style="cursor: hand">
									<font color="#FFFFFF"> <span
										style="font-weight: 700; font-size: 3pt"></span> <span
										style="font-size: 9pt; font-weight: 700">国内资费查询</span> </font>
								</td>
								<td width="101" height="30" background="images/navB.jpg"
									id="td8" onclick="loadFMoneyQuery();" align="center"
									style="cursor: hand">
									<font color="#FFFFFF"> <span
										style="font-weight: 700; font-size: 3pt"></span> <span
								...
								<td background="images/navB.jpg" id="td7"
									onclick="loadAddressQuery();" width="101" height="30"
									align="center" style="cursor: hand">
									<font color="#FFFFFF"> <span
										style="font-weight: 700; font-size: 3pt"></span> <span
						...
						<div id="scrolldiv" align="center">
									...
									<td>
										<div id="tab1" align="center">
											<s:form action="frontlogin" target="_top" namespace="/">
												<table border="0" cellpadding="0"
													style="border-collapse: collapse" width="70%" id="table16">
													<tr class="fontTr">
														<br />
														<td align="right" style="line-height: 2.5">
															<font
																style="text-align: right; font-size: 9pt; font-weight: 700">用户名:</font>
														</td>
														<td align="left">
															<input type="text" name="search.pcode" id="pcode"
																size="23"
																style="border: 1px solid #808080; background-color: #A6D7E1; width: 150px">
														</td>
													</tr>
													<tr class="fontTr">
														<td align="right" style="line-height: 2.5">
													...
													<tr class="fontTr">
														...
														<td colspan="2" align="left">
															...
															<span style="font-size: 9pt"> <input type="button"
																	...
																	style="width: 39px; height: 18px; font-size: 12px; color: #6D6D6D; border-style: outset; border-width: 0px; background-image: url('images/2wordbutton.gif'); background-position: left top">
																<input type="button" onclick="javascript:fun_forget();"
																	value="忘记密码" name="B5"
																	style="width: 66px; height: 18px; font-size: 12px; color: #6D6D6D; border-style: outset; border-width: 0px; background-image: url('images/4wordbutton.gif'); background-position: left top">
										...
										<div id="tab3" align="center" style="display: none">
												...
												<table border="0" cellpadding="0"
													...
													<tr>
														<td height="30" align="right">
															<font style="font-size: 9pt; font-weight: 700">输入单号:</font>
														</td>
													...
													<tr>
														...
														<td align="left" height="30" nowrap="nowrap"
															...
															<input type="text" name="mailverifycode"
																...
																style="border: 1px solid #808080; background-color: #A6D7E1" />
															&nbsp;&nbsp;
															<img border=0 width="60" height="18" src="/mailauthimg"
																id="mailimgcode"
													...
													<tr>
														<td height="30" align="center" colspan="2">
															...
															<span style="font-size: 9pt"> <br />&nbsp;&nbsp;&nbsp;&nbsp;
																<input type="button" value="查 询" name="B6"
													...
													<tr>
														<td colspan="3">
															...
															<br />
															<font color="#CE7000"> <span
																style="font-size: 9pt"> 温馨提示：EMS还为您提供更便捷、个性化的</span> </font>
															<font color="#CE7000"> <span
																style="font-size: 9pt"> 及 </span> </font><b> <font
																color="#005BAC" style="font-size: 9pt"> 短信追踪</font> </b>
															<font color="#CE7000"><span style="font-size: 9pt">查询快件服务，赶快来参与。</span>
															</font>
														</td>
													</tr>
												</table>
										...
										<div id="tab5" align="center" style="display: none">
											<table border="0" cellpadding="0"
												style="border-collapse: collapse" width="90%" id="table16">
												<tr>
													<td>
															...
															<tr class="fontTr"
																...
																<td colspan="4" align="left">
																	...
																	<span id="resultInfo"><font color="#CE7000"
																		style="font-size: 9pt"><br>说明：查询结果仅作为参考</font>
																	</span>
																</td>
															</tr>
											...
											<table border="0" cellpadding="0"
												...
												<tr class="fontTr">
													...
													<td width="39%" height="24" align="left">
														<span class="unnamed2"> <input name="weight"
																style="width: 150px" id="weight" type="text"
																maxlength="7" size="18" fieldname="快件重量" isneed="Y"
																checktype="number" class="input1" /> </span>
												...
												<tr class="fontTr">
													<td colspan="5" align="left">
														...
														<br />
														<span id="resultInfo"><font color="#CE7000"
															style="font-size: 9pt">说明：查询结果仅作为参考</font>
														</span>
													</td>
												</tr>
											</table>
										...
										<div id="tab8" align="center" style="display: none">
											<table border="0" cellpadding="0"
												...
												<tr class="fontTr">
													...
													<td width="39%" height="24" align="left">
														<input name="weightid1" style="width: 150px"
													...
													<tr class="fontTr">
														...
														<td align="left">
															<input type="text" id="I_DestinationPostalCode"
																style="width: 150px"
																name="search.I_DestinationPostalCode"
																disabled="disabled" />
														</td>
													</tr>
													<tr class="fontTr">
										...
										<div id="tab7" align="center" style="display: none">
											<table border="0" cellpadding="0"
												style="border-collapse: collapse" width="95%" id="table16"\>
												<tr align="center">
													...
													<td align="left" width="25%">
														地市:
														<select id="pcity" name="search.pcity"
															style="width: 150px"
							...
							<span id="scrolltransparence"
								style="display: none; border: 1px solid #666; text-align: center; vertical-align: middle"><table
									id="imgload" height=100% width=100%>
									<tr>
	...
	function login(){
		...
		<DIV id=eMeng
			style="BORDER-RIGHT: #000000 1px solid; BORDER-TOP: #FFFFFF 1px solid; Z-INDEX: 99999; VISIBILITY: hidden; BORDER-LEFT: #FFFFFF 1px solid; WIDTH: 320px; BORDER-BOTTOM: #000000 1px solid; POSITION: absolute; BACKGROUND-COLOR: #000000">
			<TABLE width="320" border=0 cellPadding=0 cellSpacing=0
				bgColor=#000000>
				<TR bgColor=#CEC8C8>
					<TD height=20
						style="font-size: 11px; background-image: url('images/title.gif'); color: #E2DEDE">
						&nbsp;&nbsp;国内时限承诺服务 光线时钟篇
					</TD>
					<TD
						style="background-image: url('images/title.gif'); padding-right: 0px; padding-top: 0px"
				...
				<TR>
					<TD height=256 colSpan=2 align="center" valign="center">
						<embed src="1.swf" width="320" height="256" PLAY="true"
							loop="true" bgcolor="#000000">
						</embed>
					</TD>
				</TR>
			</TABLE>
