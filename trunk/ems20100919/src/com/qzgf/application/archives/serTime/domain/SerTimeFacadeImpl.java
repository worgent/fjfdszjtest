...
public class SerTimeFacadeImpl implements SerTimeFacade {
	...
	@SuppressWarnings("unchecked")
	public int countSerTime(HashMap map){
		return  ((Integer)baseSqlMapDAO.queryForObject("SerTime.findSerTimeCount", map)).intValue();
	}
	...
	public List serTimeGetVerify(HashMap map){
		return   baseSqlMapDAO.queryForList("SerTime.serTimeGetVerify", map);
	}
