...
public class PrintAction extends BaseAction {
	...
	private String base64str;//数据加密码
	private String url=Constant.PrintUrl; //打印模板专用
	...
	public String execute() {
		...
		if ("".equals(super.getAction()) || null == super.getAction()
			...
			//转到框架页面
			int i=printFacade.countPrint(search);
			if(i==0){
				//默认年份
		...
		if ("listdetail".equals(super.getAction())) {
			...
			*/
			...
			int i = printFacade.alldelPrintById(search);
			java.lang.StringBuffer sb = new StringBuffer();
			sb.append("<delete>");
			sb.append("<value>").append(i).append("</value>");
			sb.append("</delete>");
