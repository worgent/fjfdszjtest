...
public class UserFacadeImpl implements UserFacade {
	...
	public int updateClientMsgCheck(HashMap map) {
		return baseSqlMapDAO.update("ClientMsg.updateClientMsgCheck", map);
	}
	
	public int updateaddressCheck(HashMap map) {
		return baseSqlMapDAO.update("Address.updateaddressCheck", map);
	}
	...
	/**
	 * 2010-06-22
	 * Purpose      : 重置密码,默认123456;
	 * @param map
	 * @return
	 */
	public int setpwd(HashMap map) {
		try {
			BASE64Encoder encoder=new BASE64Encoder();
	...
	@SuppressWarnings("unchecked")
	public int setAddress(HashMap map){
