...
<script type="text/javascript" src="<%=basePath%>js/reportmark.js"></script>
...
<link href="css/admin.css" rel="stylesheet" type="text/css" />
 <script type="text/javascript">
 	window.onload=loadReportMarkListPage("<%=path%>","<s:property value='reportId'/>","<s:property value='parentType'/>");
 </script>
</head>

<body>
<div id="reportMarkListDiv"></div><!-- 报表列表 -->
