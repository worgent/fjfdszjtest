  ...
  <tr>
    <td height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td background="<%=path%>/css/images/tab_05.gif"><img src="<%=path%>/css/images/311.gif" width="16" height="16" /> <span class="STYLE4">督办工作反馈</span></td>
...
<script language="javascript" type="text/javascript">	
		...
		function feedback(value,tablename){
		  							jPrompt('回复:', ' ', '提示框', function(r){
								    		if (r){
												            $.ajax({
												                url: "<%=path%>/work/ttomonitor.do?search.pid="+value+"&search.preplyremark="+encodeURIComponent(r)+"&search.tablename="+tablename,
												                type: "POST",
