...
public class LoginFacadeImpl implements LoginFacade{
	...
	public List findMenuById(String staffId,String subMenuId){
		...
		return baseSqlMapDAO.queryForList("MenuInfo.findMenuByStaffId", map);
	}
	...
	public List checkLogin(HashMap map) {
		return  baseSqlMapDAO.queryForList("ManagerInfo.checkLogin", map);
		
	}
	
	@SuppressWarnings("unchecked")
/*	public UserInfo checkLogin(HashMap map){
	...
	public PageList findOnlyUserList(HashMap map,Pages pages) {
		...
		List testList = baseSqlMapDAO.queryForList("ManagerInfo.findOnlyUserList", map);
