		  ...
		  <table align="center">
				...
				<tr>
					<td colspan="4">
				  	...
				  	<s:textarea cols="6" rows="6" cssStyle="width: 400px; height: 200px;overflow-y:visible;overflow-x:visible;" name="search.pbulletincontent" value="%{bulletin.BULLETINCONTENT}" label="领主招纳"></s:textarea>
				  ...
				  <tr>
				    <!-- 主键内部隐藏 -->
				  	...
				  	<s:hidden name="search.ptype" value="3"></s:hidden>
				  	<!-- googlemap的引入经纬度信息 -->
