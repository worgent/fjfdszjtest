package com.qzgf.webutils.tags.grid;
...
public class GridTag extends AbstractClosingUITag {
	 ...
	 * @return the xlsex
	 */
	public String getXlsex() {
		return xlsex;
	}
	/**
	 * @param xlsex the xlsex to set
	 */
	public void setXlsex(String xlsex) {
		this.xlsex = xlsex;
	}
}
