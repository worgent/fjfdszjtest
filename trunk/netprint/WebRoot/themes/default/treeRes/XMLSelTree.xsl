...
<xsl:variable name="LeafImgSrc">/themes/default/treeRes/images/NodeImg0.gif</xsl:variable>
<xsl:variable name="BranchImgSrc">/themes/default/treeRes/images/NodeImg1.gif</xsl:variable>
