    ...
    <script language="javascript">
		...
		Ext.onReady(function(){
		    ...
		    new Ext.Button({
		        text: '批量打印',
		        handler: function(){
		        	parent.addTab('批量EMS邮件信息','printEmsMail','/netprint/emsmail/emsmail.shtml?actionType=print','NO');
		        }
...
<body>
	...
	<tt:grid id="emsmail" value="emsmailList" pagination="true" xls="false">
		<tt:row >
			...
			<tt:col name="发件人收寄局" property="sendoffice" width="80"/>			
			<tt:col name="发件人姓名" property="sendname" width="80"/>
			<tt:col name="发件人电话" property="sendtel" width="80"/>	
			<tt:col name="发件人单位名称" property="sendunit" width="80"/>	
			<tt:col name="发件人地址" property="sendaddress" width="80"/>	
			<tt:col name="收件人姓名" property="recname" width="80"/>
			<tt:col name="收件人电话" property="rectel" width="80"/>	
			<tt:col name="收件人单位名称" property="recunit" width="80"/>	
			<tt:col name="收件人地址" property="recaddress" width="80"/>	
			...
			<tt:col name="操作" align="center" width="100">			
				<ww:if test="null != id">
					...
					<tt:authority value="DelEmsMail">
					    ...
					    <a href="javascript:parent.addTab('打印EMS邮件信息', 'printEmsMail', '/netprint/emsmail/emsmail.shtml?actionType=print&search.pid=<ww:property value="id"/>','NO')">打印</a>
				</ww:if>
			</tt:col>
		</tt:row>
	</tt:grid> 
