...
var mFields=[
  ...
  {label:"订单状态",name:"order_status",width:60,code:"order_status"},
   ...
   {label:"水酒",name:"food_name",readOnly:true},
...
//alert(str);
	...
	var firstID=getData("food_print",["order_list_id"]).order_list_id;
     ...
     var lastID=getData("food_print",["order_list_id"]).order_list_id;
       var WinPrint = window.open('../print/drinksprint.jsp?str='+str+'&type='+type+'&FOODACTION='+FOODACTION+'&hurry='+hurry+'&balconyname='+balconyname+'&orderno='+orderno+'&state='+state+'','','toolbar=no, status=no,menubar=no, scrollbars=yes,resizable=no');
}
   function goClick(){
   var dt={};
...
var toolBars=[ {text:"打印",iconCls:"gridmultiadd",handler:foodPrint},"-",
   "查询条件","&nbsp;","-",
       	                  ...
       	                  createField({name:"food_action",id:"foodaction",xtype:"combo",code:"FOOD_ACTION",emptyText:"请选择上菜标识",width:120}),
       	                   ...
       	                   "-",
       	                   createField({name:"is_print",xtype:"combo",width:90,code:"IS_PRINT",emptyText:"请选择打印标识"}),
