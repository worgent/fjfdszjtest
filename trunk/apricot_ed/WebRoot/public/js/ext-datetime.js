...
Ext.extend(Ext.ux.form.TimePickerField, Ext.form.Field, {
	...
	onRender : function(ct, position) {
		...
		this.hoursSpinner = new Ext.form.TextField(Ext.apply( {}, cfg, {
			minValue : 0,
			maxValue : 23,
			cls : 'first',
			value : values.h
		...
		this.minutesSpinner = new Ext.form.TextField(Ext.apply( {}, cfg,
				{
					minValue : 0,
					maxValue : 59,
					value : values.m
		...
		this.secondsSpinner = new Ext.form.TextField(Ext.apply( {}, cfg,
				{
					minValue : 0,
					maxValue : 59,
					value : values.s
...
Ext.form.DateTimeField = Ext.extend(Ext.form.DateField,
		{
			...
			getValue : function() {
				var date= this.parseDate(Ext.form.DateField.superclass.getValue
						.call(this)) || new Date();
				return date.dateFormat(this.dateFormat+" "+this.timeFormat);
			},
			onTriggerClick : function() {
				...
				this.menu.picker.setValue(this.parseDate(this.getValue()) || new Date());
