...
Ext.extend(Ext.SplitBar, Ext.util.Observable, {
    ...
    onEndProxyDrag : function(e){
        ...
        if(this.overlay){
            Ext.destroy(this.overlay);//replace "remove()" by "Ext.destroy"  , destroy more data. // change by guig
            delete this.overlay;
        }
        var newSize;
        if(this.orientation == Ext.SplitBar.HORIZONTAL){
    ...
    destroy : function(removeEl){
        ...
        this.dd.unreg();
        Ext.destroy(Ext.get(this.proxy));//replace "Ext.removeNode" by "Ext.destroy" , destroy more data. //change by guig
        if(removeEl){
            this.el.remove();
        }
    }
