...
Ext.form.DateTimeField = Ext.extend(Ext.form.TriggerField,  {
    ...
    getValue : function(){
       ...
       return Ext.form.DateTimeField.superclass.getValue.call(this);
    },

    /**
     * Sets the value of the date field.  You can pass a date object or any string that can be parsed into a valid
     * date, using DateTimeField.format as the date format, according to the same rules as {@link Date#parseDate}
...
dateField.setValue('2006-05-04');
    ...
    // private
    parseDate : function(value,fm){
    	  if(!fm) fm=this.format;
        if(!value || Ext.isDate(value)){
            return value;
        }
        var v = Date.parseDate(value, fm);
