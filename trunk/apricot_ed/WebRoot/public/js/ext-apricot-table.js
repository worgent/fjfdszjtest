   ...
   var list=createPageGrid({
           ...
           toolBarFields : obj.toolBar, 
       	   ...
       	   deleteFunction:function(){
       	   	   ...
       	   	   simpleForm.getForm().url=nvl(obj.deleteURL,obj.table+".delete.go");
       	   	   simpleForm.getForm().doAction("submit",getFormAction(simpleForm.getForm(),"删除数据"));
       	   },
