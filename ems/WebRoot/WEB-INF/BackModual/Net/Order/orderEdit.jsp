...
<form  method='POST' name='form1' action='/archives/user.do?action=update'  id="form1">
   ...
   <tr> 
   <td><a href="javascript:Clientiframe()">联系人</a>:</td>
   <td>
   ...
   <tr> 
   <td rowspan="2"><a href="javascript:Addressiframe()">取件地址</a>:</td>
   <td>
   <s:hidden value="%{order.ADDRESSID}" name="search.paddressid" id="paddressid"></s:hidden>
   省份: <s:textfield id="lprovince"  name="search.lprovince" value="%{order.PROVINCENAME}"></s:textfield>
        <s:hidden value="%{order.PROVINCE}" name="search.pprovince" id="pprovince"></s:hidden>
   地市： <s:textfield id="lcity"  name="search.lcity" value="%{order.CITYNAME}"></s:textfield>
        <s:hidden value="%{order.CITY}" name="search.pcity" id="pcity"></s:hidden>
   县、区：<s:textfield id="lcounty"  name="search.lcounty" value="%{order.COUNTYNAME}"></s:textfield>
