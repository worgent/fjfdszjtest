...
public class ywCommonMessage
{
    ...
    int iTimestamp;
    Returndata rData;
    static String propFileName = "/home/weblogic/MsgProp.txt";

    public ywCommonMessage()
    {
        strIcpId = "";
        strSvcType = "";
        fee_type = 2;
        ...
        {
            System.out.println("\u5F02\u5E38\uFF1A\u751F\u6210\u6587\u4EF6\u8F93\u5165\u6D41\u5931\u8D25\uFF01");
        }
        try
        {
    ...
    public Returndata SendMessage(String s, ArrayList arraylist)
    {
        ...
        int k = 0;
        cmppe_submit cmppe_submit1 = new cmppe_submit();
        cmppe_submit_result cmppe_submit_result1 = new cmppe_submit_result();
        cmppe_cancel cmppe_cancel1 = new cmppe_cancel();
        byte abyte4[] = new byte[10];
        for(int l = 0; l < strIcpId.length(); l++)
            abyte4[l] = toHex(strIcpId.charAt(l));
        ...
        for(int k1 = 0; k1 < strSrcAddr.length(); k1++)
            abyte7[k1] = toHex(strSrcAddr.charAt(k1));
...
//    }
            ...
            int l)
    {
        ...
        CutStrings cutstrings = new CutStrings();
        cutstrings.initData(s1, ",");
        String as[] = cutstrings.getMembers();
...
//        }
    ...
    public void readPa(conn_desc conn_desc1)
    {
        ...
        try
        {
            cmppe_result cmppe_result1 = cmpp.readResPack(conn_desc1);
