	 ...
	 <form method="post" action="brand!save.do" class="validate"   id="brandForm"  enctype="multipart/form-data">
	   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	     <tr>
	       ...
	       <td><input type="text" name="brand.name" id="name" maxlength="60" value=""  dataType="string" required="true" /></td>
	      </tr>
	     <tr>
	       <th><label class="text">品牌网址：</label></th>
	       <td><input type="text" name="brand.url" id="url" maxlength="60" size="40" value=""  dataType="url"/></td>
	      </tr>
	     <tr>
	     ...
	     <tr>
	       ...
	       <td>
		   <textarea id="brief" name="brand.brief"></textarea>
		   </td>
	     </tr>
