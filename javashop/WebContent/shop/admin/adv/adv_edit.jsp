...
<div class="input">
 <form class="validate" method="post" action="adv!editSave.do" name="theForm" id="theForm" enctype="multipart/form-data">
   <table cellspacing="1" cellpadding="3" width="100%" class="form-table">
     <tr>
       <th><label class="text"><input type="hidden" name="adv.aid" value="${advid }"/>广告名称：</label></th>
       <td><input type="text" name="adv.aname" value="${adv.aname }" maxlength="60" dataType="string" required="true" />       </td>
      </tr>
      <tr>
	...
	<tr>
		...
		<td><input type="radio" name="adv.isclose" value="0"
			...
			name="adv.isclose" value="1" <c:if test="${adv.isclose == 1 }">checked</c:if>/> 关闭</td>
	</tr>
	...
	<tr>
      ...
      <tr>
       ...
       <td  ><input type="text" name="adv.atturl" value="${adv.atturl }" maxlength="60" dataType="string" /></td>
      </tr>
      ...
      <tr>
       ...
       <td  ><input type="text" name="adv.company" value="${adv.company }" maxlength="60" dataType="string" /></td>
      </tr>
      
      <tr>
       <th><label class="text">联系人：</label></th>
       <td  ><input type="text" name="adv.linkman" value="${adv.linkman }" maxlength="60" dataType="string" /></td>
      </tr>
      
      <tr>
       <th><label class="text">联系方式：</label></th>
       <td  ><input type="text" name="adv.contact" value="${adv.contact }" maxlength="60" dataType="string" /></td>
      </tr>
