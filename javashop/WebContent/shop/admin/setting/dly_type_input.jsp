...
<table cellspacing="1" cellpadding="3" width="100%" class="form-table">
	<tbody>
		<tr>
			...
			<ol style="list-style: decimal outside none;">
				...
				<li style="line-height: 30px;display:none" class="division">
					...
					<div class="deliverycity" >
	                     <span id="delCfgBtn" style="float: right;"><img border="none" title="删除" alt="删除" style="width: 16px; height: 16px; background-image: url('images/ImageBundle.gif'); background-repeat: no-repeat; background-position: 0pt -91px; cursor: pointer;" src="images/transparent.gif"></span>
			...
			<span id="addCfgBtn" class="sysbtn">为指定的地区设置运费</span></div>
			</td>
		</tr>
	</tbody>
</table>
