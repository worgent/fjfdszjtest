...
<grid:grid  from="webpage"  >
  ...
  <grid:body item="gift" >
        ...
        <grid:cell>&nbsp; <html:dateformat time="${gift.starttime}" pattern="yyyy-MM-dd"></html:dateformat>  </grid:cell>
        <grid:cell>&nbsp; <html:dateformat time="${gift.endtime}" pattern="yyyy-MM-dd"></html:dateformat>  </grid:cell> 
