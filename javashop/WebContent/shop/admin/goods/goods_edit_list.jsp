...
<grid:grid  from="webpage">
  ...
  <grid:body item="goods" >
        ...
        <grid:cell><div><input type="checkbox" class="editinput market_enable"  <c:if test="${goods.market_enable==1}" >checked="true"</c:if> /><input type="hidden" name="market_enable" value="${goods.market_enable }" /></div></grid:cell>
