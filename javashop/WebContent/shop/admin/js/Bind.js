var Bind={
	...
	appendGoods:function(productList){
		for(i in productList){
			...
			var html = "<tr class='product_item_" + product.product_id + "'><td><a href='javascript:;' class='delete'></a><input type='hidden' name='product_id' value='" + product.product_id + "' /></td><td>"+product.name+"</td><td><input type='text' name='pkgnum' value='1' mkt_price='"+ product.price +"' weight='"+product.weight+"'/></td></tr>";
