var DlyTypeInput={
		...
		init:function(){
			$('#detail' ).ckeditor( );	
		 	var self = this;
			Eop.Dialog.init({id:"area_selected",modal:false,title:"选择地区",width:"300px",height:"400px"});
			Eop.Dialog.init({id:"check_exp_dlg",modal:false,title:"验证公式",width:"600px",height:"400px"});
