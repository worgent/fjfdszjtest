...
public class DataFieldManager extends  BaseSupport<DataField>   implements IDataFieldManager {
	...
	public Integer add(DataField dataField) {
		...
		sql.append(" add ");
		sql.append( this.getFieldTypeSql(dataField.getEnglish_name(), dataField.getData_type() ) );
	 ...
	 * @return
	 */
	private   String getFieldTypeSql(String field_name,int data_type){
		String data_type_str="";
		if(data_type==1){
			data_type_str = field_name+" varchar(255)";
		}
		if(data_type==2){
			data_type_str = field_name+" text";
		}
//		if(data_type == 3 ){
//			data_type_str = field_name+" double("+data_size+")";
//		}
//		if(data_type == 4 ){
//			data_type_str = field_name+" text";
//		}
//		if(data_type== 5){
//			data_type_str = field_name+" datetime";
//		}
//		if(data_type == 6){
//			data_type_str = field_name+" varchar("+data_size+")";
//		}
