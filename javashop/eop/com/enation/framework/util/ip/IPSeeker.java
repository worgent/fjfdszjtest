...
public class IPSeeker {
    ...
    //纯真IP数据库名  
    private static final String IP_FILE=IPSeeker.class.getClassLoader().getResource("com/enation/framework/util/ip/QQWry.Dat").toString().substring(5);  
    ...
    public static void main(String[] args){
		...
		//测试IP 58.20.43.13  
		System.out.println(ip.getIPLocation("60.15.93.239").getCountry() + ":"
				+ ip.getIPLocation("60.15.93.239").getArea());
		System.out.println(DateUtil.toString(new Date(), "yyMMddHHmmss ssss"));
		...
		System.out.println(new IPSeeker() .getCountry("127.0.0.1"));
		*/
