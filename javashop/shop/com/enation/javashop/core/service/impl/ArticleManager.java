...
public class ArticleManager extends BaseSupport implements IArticleManager {
	...
	public List listByCatId(Integer cat_id) {
		...
		String sql = "select a.*,b.cat_path from "+this.getTableName("article") + " a left join " + this.getTableName("article_cat") + " b on b.cat_id = a.cat_id where cat_path like '" + cat_path + "%' order by create_time ";
