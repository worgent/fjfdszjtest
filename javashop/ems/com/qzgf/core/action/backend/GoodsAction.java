...
public class GoodsAction extends WWAction {
	...
	protected IGoodsCatManager emsgoodsCatManager;
	protected IGoodsManager emsgoodsManager;
	...
	public String list(){		
		...
		this.webpage = emsgoodsManager.searchGoods(catid,name,sn,order, this.getPage(),this.getPageSize());
	...
	public String batchEdit(){
		...
		try{
			this.emsgoodsManager.batchEdit();
			this.json ="{result:1}";
	...
	public String getCatTree(){
		this.catList = this.emsgoodsCatManager.listAllChildren(0);
		return "cat_tree";
	}
	
	//商品回收站列表
	public String trash_list(){
		this.webpage = this.emsgoodsManager.pageTrash(name, sn, order, this.getPage(), this.getPageSize());
		return "trash_list";
	}
	...
	public String delete(){
		try{
			this.emsgoodsManager.delete(id);
	...
	public String revert(){
		try{
			this.emsgoodsManager.revert(id);
	...
	public String add() {
		...
		tagHtmlList = emsgoodsManager.fillAddInputData();
	...
	public String  edit(){
		...
		GoodsEditDTO editDTO = this.emsgoodsManager.getGoodsEditData(goods_id);
	...
	/**
	 * Purpose      : 说明
	 * @return the emsgoodsManager
	 */
	public IGoodsManager getEmsgoodsManager() {
		return emsgoodsManager;
	}

	/**
	 * Purpose      : 说明
	 * @param emsgoodsManager the emsgoodsManager to set
	 */
	
	public void setEmsgoodsManager(IGoodsManager emsgoodsManager) {
		this.emsgoodsManager = emsgoodsManager;
	}
