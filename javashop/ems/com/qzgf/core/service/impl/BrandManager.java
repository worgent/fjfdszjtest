...
import com.qzgf.core.model.mapper.BrandMapper;
...
public class BrandManager extends BaseSupport<Brand> implements IBrandManager {
	...
	public Page getGoods(Integer brand_id, int pageNo, int pageSize) {
		String sql = "select * from ems_goods where brand_id=? and disabled=0";
	...
	public List listByCatId(Integer catid) {
		String sql ="select b.* from brand b ,type_brand tb,ems_goods_cat c where tb.brand_id=b.brand_id and c.type_id=tb.type_id and c.cat_id=?";
