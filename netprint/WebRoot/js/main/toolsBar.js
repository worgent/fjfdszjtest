Ext.onReady(function() {
			...
			bottom=	new Ext.Toolbar({id:"bottom",frame:true,region:"south",height:25,items:["当前用户：",currentUser,new Ext.Toolbar.Fill(),"版权所有　2011  <font color=blue>泉州市冠发信息科技有限公司</font>　　　　"]});
