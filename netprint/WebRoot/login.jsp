		...
		<table cellspacing=0 cellpadding=0 width=1004 border=0>
		          ...
		          <td>
		            <table id=table2 cellspacing=1 cellpadding=0 width="100%" 
		              ...
		              <tr>
		                ...
		                <td><input class="wenbenkuang check" verify="string" required="true" shade="true" requiredColor="#ffffff" name="staffNo" type="text" id="staffNo" size="20"  value="" tabindex="1"><a href="javascript:regUser()"><font color=#ffffff>注册</font></a>&nbsp;&nbsp;<a href="\setup.EXE"><font color=#ffffff>打印控件下载</font></a></td></tr>
		              <tr>
		                <td align="left" width=61><font color=#ffffff>密 码：</font></td>
		                <td><input class="wenbenkuang check" verify="string" required="true" shade="true" requiredColor="#ffffff" name="password" type="password" id="password" size="20" value="" tabindex="2"></td></tr>
		              </tbody>
		             </table>
		          </td>
		       </tr>
		  ...
		  <tr>
		    ...
		    <td><input name="imageField" value="管理登录"   type=image height=48 alt="" width=86 
		      src="/images/login/crm_17.gif" tabindex="3" ></td>
