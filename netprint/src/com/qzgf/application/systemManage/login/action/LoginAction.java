		...
		if (!"firstPageManage".equals(actionType)) {
			...
			if (null != userInfo) {
				...
				{	
					...
					ActionContext.getContext().getSession().put("left_marginex", search.get("left_marginex").toString());
					ActionContext.getContext().getSession().put("top_marginex", search.get("top_marginex").toString());
