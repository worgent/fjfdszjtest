MainPanel = function() {
	...
	this.refresh=function()	{
		document.homePageIframe.window.location.reload();
		//if(this.currentUrl){
	...
	MainPanel.superclass.constructor.call(this, {
		...
		items : [{
			...
			title : '桌　面',
			closable : false,
			html :"<iframe id='homePageIframe' name='homePageIframe' src='"+this.homePage+"'width='100%' height='100%' frameborder=0/>",
			autoScroll : true,
			tbar : [/*{text:'主页',
						cls:"x-btn-text-icon",
						...
						handler:function(){
							window.open("http://www.gotop.net.cn/")
							//alert('泉州市冠发信息科技有限公司');
						}
					}]
		}]
