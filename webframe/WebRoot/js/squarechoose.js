...
function SquareChoose(pmap,callbackfun){
	//地图对象
    var map=pmap;
    //矩形临时变量
    var polyShape;
...
function SquareChooseControl() {
 ...
 SquareChooseControl.prototype = new GControl();


SquareChooseControl.prototype.getDefaultPosition = function() {
