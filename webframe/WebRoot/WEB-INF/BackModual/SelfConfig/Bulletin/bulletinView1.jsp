...
<html>
	...
	<tr>
	<td>
	<s:textarea theme="xhtml" cols="6" rows="6" cssStyle="width: 400px; height: 200px;overflow-y:visible;overflow-x:visible;" name="search.pbulletincontent" value="%{bulletin.BULLETINCONTENT}" label="优惠劵内容" readonly="true"></s:textarea>
	</td>
	</tr>
	<tr>
		 <!-- 地图显示 -->
