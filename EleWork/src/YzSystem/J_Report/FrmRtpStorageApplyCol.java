...
public class FrmRtpStorageApplyCol extends FrmFunctionBase {
	String qry_GroupbySQL="";
    public FrmRtpStorageApplyCol() throws wlglException {
 	   super();
	   setQueryComp();
       // 设置查询SQL
	   setQueryInfo();
    ...
    private void setQueryInfo() {
        qry_selectSQL ="select a.ApplyDepCode, c.TheName ApplyDepName,sum(IFNULL(e.TotalMoney,0)) TotalMoney, sum(IFNULL(e.Number,0)) Number" +
        ...
        qry_orderSQL = "order by c.TheName ";
