...
public class FrmStoragein extends FrmFunctionBase{
	    public String billType = "2003";
	    public String pre = "BJLK";
	    public void init() {
	    }

	    //生成的页面流程控制
	    public FrmStoragein() throws wlglException {
	        super();
	        init();
	        // 设置页面标题
	        Table = "tbstoragein";
	        seqnField = "BillNo";
	        DetailTable = "tbstorageinitem";
	...
	//=========================修改设置==============================================
	    ...
	    private void setQueryInfo() {
	        qry_selectSQL ="select  a.BillNo, a.TheDate, a.SupplyerCode,b.TheName SupplyerName, a.CopartnerType,c.theName CopartnerTypeName," +
	        		"\n"+"a.StockMode, d.TheName StockModeName,a.StorageCode,e.TheName StroageName,a.BillSortCode,f.BillName BillSortName,a.Remark" +
	        		"\n"+"from tbstoragein a left outer join tbdatumcopartner b on a.SupplyerCode=b.TheCode and  a.CopartnerType=b.CopartnerType" +
	        		"\n"+"left outer join (select a.RowNo,a.TheName from tssystemsubjectrecord  a left outer join tssystemrecord b on " +
	        		"\n"+"b.TheCode=a.TheCode and b.SubjectSort=b.SubjectSort where b.Flag='CopartnerType') c on c.RowNo=a.CopartnerType" +
	        		"\n"+"left outer join (select a.RowNo,a.TheName from tssystemsubjectrecord  a left outer join tssystemrecord b on " +
	        		"\n"+"b.TheCode=a.TheCode and b.SubjectSort=b.SubjectSort where b.Flag='StockMode') d on d.RowNo=a.CopartnerType" +
	        		"\n"+"left outer join tbdatumstorage e on e.TheCode=a.StorageCode" +
	        		"\n"+"left outer join vbillsort f on a.BillSortCode=f.BillSort";
	    ...
	    protected void setUpdateComp() throws wlglException {
	        ...
	        ec3.setField("SupplyerCode");
	        ec3.setCaption("供应商");
	        ec3.setDisID("SupplyerName");
	        ...
	        ec5.setEdtType("StockMode");
	        ec5.setField("StockMode");
	        ec5.setCaption("采购方式");
	        ec5.setDisID("StockModeName");
	        ec5.setDefDisValue("＝请选择＝");
	        ec5.setMode("readonly");
	        
	        EditComponent ec6 = new EditComponent();
	        ec6.setEdtType("Storage");
	        ec6.setField("StorageCode");
	        ec6.setCaption("仓库");
	        ec6.setDisID("StroageName");
	        ec6.setDefDisValue("＝请选择＝");
	    ...
	    protected void setUpdateInfo() {
	        ...
	        edt_selectSQL ="select  a.BillNo, a.TheDate, a.SupplyerCode,b.TheName SupplyerName, a.CopartnerType,c.theName CopartnerTypeName," +
    		"\n"+"a.StockMode, d.TheName StockModeName,a.StorageCode,e.TheName StroageName,a.BillSortCode,f.BillName BillSortName,a.Remark" +
    		"\n"+"from tbstoragein a left outer join tbdatumcopartner b on a.SupplyerCode=b.TheCode and  a.CopartnerType=b.CopartnerType" +
    		"\n"+"left outer join (select a.RowNo,a.TheName from tssystemsubjectrecord  a left outer join tssystemrecord b on " +
    		"\n"+"b.TheCode=a.TheCode and b.SubjectSort=b.SubjectSort where b.Flag='CopartnerType') c on c.RowNo=a.CopartnerType" +
	    ...
	    private void setDetailQueryInfo() {
	        ...
	        detailSelectSQL = "select a.BillNo, a.RowNo, a.ProductCode, b.TheName ProductName,a.ProductSort,c.TheName ProductTypeName," +
	        		...
	        		"\n"+"from tbstorageinitem a  left outer join tbdatumproduct b on a.ProductCode=b.TheCode and a.ProductSort=b.ProductTypeCode"+
