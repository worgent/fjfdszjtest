...
public class FrmTel extends FrmFunctionBase{
	  public String billType = "1001";
	    public String pre = "DH";
		
		   public FrmTel() throws wlglException {
		        super();
		    ...
		    EditComponent e1 = new EditComponent("", "单据号", "a.BillNo", "like",
					"QBillNo", "", "", "", "", "");
		    ...
		    private void setEditComp() throws wlglException {
		        ...
		        */
		        ...
		        tre3.getElements().add(ec11.genHttpBase());
		    ...
		    private void setUpdateInfo() {
		        ...
		        //editColumns.setProperty("7", "9");//人员安排
		        ...
		        editColumns.setProperty("11d", "17");
		        editColumns.setProperty("12", "18");
		        
		        editColumns.setProperty("13", "19");
		        editColumns.setProperty("14", "20");
		        editColumns.setProperty("14d", "21");
		        editColumns.setProperty("15", "22");
		        editColumns.setProperty("15d", "23");
