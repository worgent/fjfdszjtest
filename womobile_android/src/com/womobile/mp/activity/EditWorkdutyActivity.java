...
public class EditWorkdutyActivity extends Activity {
	...
	private void setListeners() {
	    okBtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (validation()) {
					int number = 0;
					number = updateWorkduty(Workduty.CONTENT_URI
							,Workduty.KEY_ID
							,Workduty.KEY_TITLE
							,Workduty.KEY_DETAIL
					...
					if (number != 0) {
						...
						Toast.makeText(EditWorkdutyActivity.this, "修改失败，请检查数据",
	...
	private int updateWorkduty(Uri uriType
				,String ID
				,String TITLE
				,String DETAIL
				,String ADJUNCT
		...
		int number = getContentResolver().update(uriType, values
				,FieldSupport.KEY_ID +"="+Workduty_id, null);
	...
	private void setTextFileds(Intent intent) {
		...
		Workduty_id = Integer.parseInt(map.get(FieldSupport.KEY_ID));
		
		 IDEdt.setText(map.get(Workduty.KEY_ID));
		 TITLEEdt.setText(map.get(Workduty.KEY_TITLE));
		 DETAILEdt.setText(map.get(Workduty.KEY_DETAIL));
		 ADJUNCTEdt.setText(map.get(Workduty.KEY_ADJUNCT));
		 TARGETEdt.setText(map.get(Workduty.KEY_TARGET));
		 FORMATEdt.setText(map.get(Workduty.KEY_FORMAT));
		 PROIDEdt.setText(map.get(Workduty.KEY_PROID));
		 ATTITUDEEdt.setText(map.get(Workduty.KEY_ATTITUDE));
		 GRADEEdt.setText(map.get(Workduty.KEY_GRADE));
		 ISENDEdt.setText(map.get(Workduty.KEY_ISEND));
		 FLOWER_STATEEdt.setText(map.get(Workduty.KEY_FLOWER_STATE));
		 PROCESS_CODEEdt.setText(map.get(Workduty.KEY_PROCESS_CODE));
		 AUDITING_CODEEdt.setText(map.get(Workduty.KEY_AUDITING_CODE));
		 BILL_STATEEdt.setText(map.get(Workduty.KEY_BILL_STATE));
		 CREATE_CODEEdt.setText(map.get(Workduty.KEY_CREATE_CODE));
		 CREATE_DATEEdt.setText(map.get(Workduty.KEY_CREATE_DATE));
		 EDITOR_CODEEdt.setText(map.get(Workduty.KEY_EDITOR_CODE));
		 EDITOR_DATEEdt.setText(map.get(Workduty.KEY_EDITOR_DATE));
		 FEEDBKIDEdt.setText(map.get(Workduty.KEY_FEEDBKID));
	...
	private boolean validation() {
		...
		*/
		if (tag.equals(""))
			...
			Toast.makeText(EditWorkdutyActivity.this, tag, Toast.LENGTH_LONG)
					.show();
			return false;
		}
	}
	...
	private void openSuccessDialog() {
		new AlertDialog.Builder(EditWorkdutyActivity.this).setTitle("").setMessage(
