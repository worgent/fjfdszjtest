...
public class AddCollectionActivity extends Activity {
	    ...
	    okBtn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (validation()) {
					...
					uri = AddCollection(Collection.CONTENT_URI
							,Collection.KEY_ID
					...
					if (uri != null) {
						...
						Toast.makeText(AddCollectionActivity.this, "添加失败，请检查数据",
	...
	private Uri AddCollection(Uri uriType
				,String ID
				,String TITLE
				,String DETAIL
				,String ADJUNCT
	...
	private boolean validation() {
		...
		if (tag.equals(""))
			...
			Toast.makeText(AddCollectionActivity.this, tag, Toast.LENGTH_LONG)
					.show();
			return false;
		}
	}
	...
	private void openSuccessDialog() {
		new AlertDialog.Builder(AddCollectionActivity.this).setTitle("").setMessage(
