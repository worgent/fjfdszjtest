...
<%--<object ID='WebBrowser' WIDTH=0 HEIGHT=0 CLASSID='CLSID:8856F961-340A-11D0-A96B-00C04FD705A2'></object> 
 ...
 <%
	...
	SimpleDateFormat sdf1=new SimpleDateFormat("yyyy年MM月dd日 HH:mm:ss");
		...
		String USER="root";//zhaoweizi
		String PASSWORD="123@123";//13807084531
		boolean flag;
		try {
		String sql="";
		 sql=sql+"select t1.*,t2.food_name,t3.* from order_list t1,food_info t2,order_info t3 where t1.food_id=t2.food_id and  t3.order_id=t1.order_id and t2.food_type in ('00','01','02','03','09','10','06') and t3.order_time like '"+time+"%' ";
			...
			if(request.getParameter("isprint").trim()!=""){
				String first=request.getParameter("isprint");
				sql=sql+" and t1.is_print='"+first+"'";
			}else{
...
//System.out.print(sql);
				...
				<table width="95%" align=center>
					...
					<table border=0 width="95%" align=center id="tabHeader">
					    <tr>
					        <td align="center"><font size='3' face='楷体_gb2312'>菜单打印</font></td>
				...
				while(rs.next())
				{
				//System.out.print(rs.getString("order_list_id"));
				...
				stmt1.executeUpdate(sql1);
					%>
						...
						<tr>
							...
							<td><%if("0".equals(rs.getString("order_type"))){
							 		out.print("普通");
							 	} else if("1".equals(rs.getString("order_type"))){
							 		out.print("网上预定");
							 	}
							 	else if("2".equals(rs.getString("order_type"))){
							 		out.print("电话预订");
							 	}
							 	else if("3".equals(rs.getString("order_type"))){
							 		out.print("店面预定");
							 	}else{
							 		out.print("外卖单");
							 	}%></td>
							<td><%if("0".equals(rs.getString("order_status"))){
							 		out.print("未结帐");
							 	} else if("1".equals(rs.getString("order_status"))){
							 		out.print("已经结帐");
							 	}else if("2".equals(rs.getString("order_status"))){
							 		out.print("预定");
							 	}else if("3".equals(rs.getString("order_status"))){
							 		out.print("取消");
							 	}else{
							 		out.print("记帐");
							 	}%></td>
